...
declarePublicCounter(kvstore_tryput_exhausted_total, "kvstore tryPut max retries exhausted")

# tryPutAtomic (all-or-nothing)
declarePublicCounter(kvstore_tryputatomic_total, "kvstore tryPutAtomic calls")
declarePublicCounter(kvstore_tryputatomic_retries_total, "kvstore tryPutAtomic retry iterations")
...
declarePublicCounter(kvstore_trydelete_retries_total, "kvstore tryDelete retry iterations")
declarePublicCounter(kvstore_trydelete_exhausted_total, "kvstore tryDelete max retries exhausted")
...
declarePublicCounter(
  kvstore_trydeleteatomic_exhausted_total, "kvstore tryDeleteAtomic max retries exhausted"
)
